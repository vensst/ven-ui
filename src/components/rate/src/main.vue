...
export default {
  ...
  props: {
    ...
    iconClasses: {
      type: [Array, Object],
      default() {
        return ["ven-icon-star-on", "ven-icon-star-on", "ven-icon-star-on"];
      },
    },
    voidIconClass: {
      type: String,
      default: "ven-icon-star-off",
    },
    disabledVoidIconClass: {
      type: String,
      default: "ven-icon-star-on",
    },
    disabled: {
      type: Boolean,
      default: false,
  ...
  methods: {
    ...
    setCurrentValue(value, event) {
      ...
      if (this.allowHalf) {
        ...
        if (hasClass(target, "ven-rate__item")) {
          target = target.querySelector(".ven-rate__icon");
        }
        if (hasClass(target, "ven-rate__decimal")) {
